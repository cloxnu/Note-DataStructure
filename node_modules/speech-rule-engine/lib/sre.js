...
sre.Grammar.prototype.runProcessors_=function(a,b){for(var c in this.parameters_){var d=b[c];if(d){var e=this.parameters_[c];a=!0===e?d(a):d(a,e)}}return a};sre.Grammar.translateString_=function(a){var b=sre.Engine.getInstance();a=b.evaluator(a,b.dynamicCstr)||a;return sre.Grammar.cleanUnit_(a)};sre.Grammar.cleanUnit_=function(a){return a.match(/:unit$/)?(sre.Grammar.getInstance().setParameter("plural",!1),a.replace(/:unit$/,"")):a};
...
sre.SemanticNodeCollator.prototype.collateMeaning=function(){var a=new sre.SemanticMeaningCollator,b;for(b in this.map_)a.map_[b]=this.map_[b].map(function(a){return a.meaning()});return a};sre.SemanticMeaningCollator=function(){sre.SemanticCollator_.call(this)};goog.inherits(sre.SemanticMeaningCollator,sre.SemanticCollator_);sre.SemanticMeaningCollator.prototype.copyCollator=function(){return new sre.SemanticMeaningCollator};
...
(a.type=sre.SemanticAttr.Type.IDENTIFIER);sre.SemanticProcessor.exprFont_(a);return a};sre.SemanticProcessor.prototype.implicitNode_=function(a){var b=sre.SemanticProcessor.getInstance().factory_.makeMultipleContentNodes(a.length-1,sre.SemanticAttr.invisibleTimes()),c=sre.SemanticProcessor.getInstance().infixNode_(a,b[0]);c.role=sre.SemanticAttr.Role.IMPLICIT;b.forEach(function(a){a.parent=c});c.contentNodes=b;return c};
...
sre.SemanticProcessor.prototype.combineUnits_=function(a){var b=sre.SemanticProcessor.partitionNodes_(a,function(a){return!sre.SemanticPred.isAttribute("role","UNIT")(a)});if(a.length===b.rel.length)return b.rel;a=[];do{var c=b.comp.shift(),d=b.rel.shift(),e=null,f=a.pop();f&&(c.length&&sre.SemanticPred.isUnitCounter(f)?c.unshift(f):a.push(f));1===c.length&&(e=c.pop());1<c.length&&(e=sre.SemanticProcessor.getInstance().implicitNode_(c),e.role=sre.SemanticAttr.Role.UNIT);e&&a.push(e);d&&a.push(d)}while(d);
return a};
...
sre.SemanticProcessor.prototype.getPunctuationInRow_=function(a){if(1>=a.length)return a;var b=function(a){a=a.type;return"punctuation"===a||"text"===a||"operator"===a||"relation"===a},c=sre.SemanticProcessor.partitionNodes_(a,function(c){if(!sre.SemanticPred.isPunctuation(c))return!1;if(sre.SemanticPred.isPunctuation(c)&&!sre.SemanticPred.isAttribute("role","ELLIPSIS")(c))return!0;var d=a.indexOf(c);if(0===d)return a[1]&&b(a[1])?!1:!0;c=a[d-1];if(d===a.length-1)return b(c)?!1:!0;d=a[d+1];return b(c)&&
b(d)?!1:!0});if(0===c.rel.length)return a;var d=[],e=c.comp.shift();0<e.length&&d.push(sre.SemanticProcessor.getInstance().row(e));for(var f=0;0<c.comp.length;)d.push(c.rel[f++]),e=c.comp.shift(),0<e.length&&d.push(sre.SemanticProcessor.getInstance().row(e));return[sre.SemanticProcessor.getInstance().punctuatedNode_(d,c.rel)]};
...
digitPrefix:{default:""}},ALPHABET_COMBINER:function(a,b,c){a=c?a+" "+c:a;return b?a+" "+b:a}};sre.Numbers.nemeth={};sre.Numbers.nemeth.oneNumbers_="\u2834\u2802\u2806\u2812\u2832\u2822\u2816\u2836\u2826\u2814".split("");sre.Numbers.nemeth.numberToWords=function(a){return a.toString().split("").map(function(a){return sre.Numbers.nemeth.oneNumbers_[parseInt(a,10)]}).join("")};sre.Numbers.nemeth.NUMBERS={numberToWords:sre.Numbers.nemeth.numberToWords};var postfixCombiner=function(a,b,c){return b?a+b:a},embellishCombiner=function(a,b,c){return b+(c?c:"\u2830")+a+"\u283b"},doubleEmbellishCombiner=function(a,b,c){return b+(c?c:"\u2830")+a+"\u283b\u283b"},parensCombiner=function(a,b,c){return b+(c?c:"\u2830")+a+"\u283e"};
...
sre.ClearspeakPreferences.PREFERENCES=new sre.DynamicProperties({AbsoluteValue:["Auto","AbsEnd","Cardinality","Determinant"],Bar:["Auto","Conjugate"],Caps:["Auto","SayCaps"],CombinationPermutation:["Auto","ChoosePermute"],Currency:["Auto","Position","Prefix"],Ellipses:["Auto","AndSoOn"],Exponent:["Auto","AfterPower","Ordinal","OrdinalPower"],Fraction:"Auto EndFrac FracOver General GeneralEndFrac Ordinal Over OverEndFrac Per".split(" "),Functions:["Auto","None","Reciprocal"],ImpliedTimes:["Auto","MoreImpliedTimes",
"None"],Log:["Auto","LnAsNaturalLog"],Matrix:"Auto Combinatoric EndMatrix EndVector SilentColNum SpeakColNum Vector".split(" "),MultiLineLabel:"Auto Case Constraint Equation Line None Row Step".split(" "),MultiLineOverview:["Auto","None"],MultiLinePausesBetweenColumns:["Auto","Long","Short"],MultsymbolDot:["Auto","Dot"],MultsymbolX:["Auto","By","Cross"],Paren:"Auto CoordPoint Interval Silent Speak SpeakNestingLevel".split(" "),Prime:["Auto","Angle","Length"],Roots:["Auto","PosNegSqRoot","PosNegSqRootEnd",
"RootEnd"],SetMemberSymbol:["Auto","Belongs","Element","Member"],Sets:["Auto","SilentBracket","woall","woAll"],TriangleSymbol:["Auto","Delta"],Trig:["Auto","ArcTrig","TrigInverse","Reciprocal"],VerticalLine:["Auto","Divides","Given","SuchThat"]});
...
sre.ClearspeakUtil.firstCurrency=function(a){var b=sre.XpathUtil.evalXPath("children/*[1]",a)[0];return b&&"currency"===sre.MathCompoundStore.getInstance().lookupCategory(b.textContent+":unit")?[a]:[]};sre.ClearspeakUtil.lastCurrency=function(a){var b=sre.XpathUtil.evalXPath("children/*[last()]",a)[0];return b&&"currency"===sre.MathCompoundStore.getInstance().lookupCategory(b.textContent+":unit")?[a]:[]};sre.ClearspeakFrench=function(){sre.MathStore.call(this);this.locale="fr"};goog.inherits(sre.ClearspeakFrench,sre.MathStore);goog.addSingletonGetter(sre.ClearspeakFrench);sre.ClearspeakFrench.mathStore=sre.ClearspeakFrench.getInstance();sre.ClearspeakFrench.defineRule_=goog.bind(sre.ClearspeakFrench.mathStore.defineRule,sre.ClearspeakFrench.mathStore);sre.ClearspeakFrench.defineRuleAlias_=goog.bind(sre.ClearspeakFrench.mathStore.defineRulesAlias,sre.ClearspeakFrench.mathStore);
...
'text()!="0"');(0,sre.ClearspeakRules.defineRule_)("exponent","clearspeak.Exponent_OrdinalPower",'[t] "zero"',"self::number",'@role="integer"','contains(@grammar, "ordinal")','text()="0"');(0,sre.ClearspeakRules.defineRule_)("square","clearspeak.default",'[n] children/*[1]; [t] "squared"',"self::superscript",'@role!="unit"','children/*[2][text()="2"]','name(children/*[1])!="text" or not(name(children/*[1])="text" and (name(../../../punctuated[@role="text"]/..)="stree" or name(..)="stree"))',"self::*");
(0,sre.ClearspeakRules.defineRule_)("cube","clearspeak.default",'[n] children/*[1]; [t] "cubed"',"self::superscript",'@role!="unit"','children/*[2][text()="3"]','name(children/*[1])!="text" or not(name(children/*[1])="text" and (name(../../../punctuated[@role="text"]/..)="stree" or name(..)="stree"))',"self::*");(0,sre.ClearspeakRules.defineRule_)("paren-simple","clearspeak.default","[n] children/*[1]","self::fenced",'@role="leftright"','contains(children/*[1]/@annotation, "clearspeak:simple")','name(../..)!="superscript" and name(../..)!="subscript"');
...
'[n] children/*[2] (grammar:combinatorics); [t] "permute"; [n] children/*[4] (grammar:combinatorics)',"self::tensor",'name(children/*[3])="empty"','name(children/*[5])="empty"','children/*[1][text()="P"]');(0,sre.ClearspeakRules.defineRule_)("unit-singular","clearspeak.default",'[t] text() (grammar:annotation="unit":translate)',"self::identifier",'@role="unit"');(0,sre.ClearspeakRules.defineRule_)("unit-plural","clearspeak.default",'[t] text() (grammar:annotation="unit":translate:plural)',"self::identifier",
'@role="unit"','not(contains(@grammar, "singularUnit"))');(0,sre.ClearspeakRules.defineRule_)("unit-square","clearspeak.default",'[t] "square"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=2]",'name(children/*[1])="identifier"');(0,sre.ClearspeakRules.defineRule_)("unit-cubic","clearspeak.default",'[t] "cubic"; [n] children/*[1]',"self::superscript",'@role="unit"',"children/*[2][text()=3]",'name(children/*[1])="identifier"');(0,sre.ClearspeakRules.defineRule_)("unit-reciprocal",
"clearspeak.default",'[t] "reciprocal"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'count(preceding-sibling::*)=0 or preceding-sibling::*[@role!="unit"]');(0,sre.ClearspeakRules.defineRule_)("unit-reciprocal","clearspeak.default",'[t] "per"; [n] children/*[1] (grammar:singularUnit)',"self::superscript",'@role="unit"','name(children/*[1])="identifier"',
'name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'preceding-sibling::*[@role="unit"]');(0,sre.ClearspeakRules.defineRule_)("unit-combine","clearspeak.default","[m] children/*","self::infixop",'@role="unit"');(0,sre.ClearspeakRules.defineRule_)("unit-combine-singular","clearspeak.default","[n] children/*[1]; [n] children/*[2] (grammar:singularUnit); [m] children/*[position()>2]","self::infixop",'@role="unit"','name(children/*[1])="number"',
"children/*[1][text()=1]");(0,sre.ClearspeakRules.defineRule_)("unit-divide","clearspeak.default",'[n] children/*[1]; [t] "per"; [n] children/*[2] (grammar:singularUnit)',"self::fraction",'@role="unit"');(0,sre.ClearspeakRules.defineRule_)("currency","clearspeak.default","[m] children/*[position()>1]; [n] children/*[1];","self::infixop",'contains(@annotation, "clearspeak:unit")','children/*[1][@role="unit"]',"CQFfirstCurrency");(0,sre.ClearspeakRules.defineRule_)("currency","clearspeak.Currency_Position",
"[m] children/*","self::infixop",'contains(@annotation, "clearspeak:unit")');(0,sre.ClearspeakRules.defineSpecialisedRule_)("currency","clearspeak.Currency_Position","clearspeak.Currency_Prefix");(0,sre.ClearspeakRules.defineRule_)("currency","clearspeak.Currency_Prefix","[n] children/*[last()]; [m] children/*[position()<last()]; ","self::infixop",'contains(@annotation, "clearspeak:unit")','children/*[last()][@role="unit"]',"CQFlastCurrency")};
sre.ClearspeakRules.getInstance().initializer=[sre.ClearspeakRules.initCustomFunctions_,sre.ClearspeakRules.initClearspeakRules_,sre.ClearspeakRules.addAnnotators_];sre.Grammar.getInstance().setPreprocessor("numbers2alpha",sre.ClearspeakUtil.numbersToAlpha);sre.EmacspeakRules=function(){sre.MathStore.call(this)};goog.inherits(sre.EmacspeakRules,sre.MathStore);goog.addSingletonGetter(sre.EmacspeakRules);sre.EmacspeakRules.mathStore=sre.EmacspeakRules.getInstance();sre.EmacspeakRules.defineRule_=goog.bind(sre.EmacspeakRules.mathStore.defineRule,sre.EmacspeakRules.mathStore);sre.EmacspeakRules.defineRuleAlias_=goog.bind(sre.EmacspeakRules.mathStore.defineRuleAlias,sre.EmacspeakRules.mathStore);
...
sre.EmacspeakRules.initCustomFunctions_=function(){(0,sre.EmacspeakRules.addContextFunction_)("CTXFnodeCounter",sre.StoreUtil.nodeCounter);(0,sre.EmacspeakRules.addContextFunction_)("CTXFcontentIterator",sre.StoreUtil.contentIterator);(0,sre.EmacspeakRules.addCustomQuery_)("CQFvulgarFractionSmall",sre.MathspeakUtil.isSmallVulgarFraction);(0,sre.EmacspeakRules.addCustomString_)("CSFvulgarFraction",sre.NumbersUtil.vulgarFraction)};
...
"[m] children/*","self::punctuated");(0,sre.MathspeakFrench.defineRule_)("unit","mathspeak.default",'[t] text() (grammar:annotation="unit":translate)',"self::identifier",'@role="unit"');(0,sre.MathspeakFrench.defineRule_)("unit-square","mathspeak.default",'[n] children/*[1]; [t] "carr\u00e9"',"self::superscript",'@role="unit"',"children/*[2][text()=2]",'name(children/*[1])="identifier"');(0,sre.MathspeakFrench.defineRule_)("unit-cubic","mathspeak.default",'[n] children/*[1]; [t] "cubique"',"self::superscript",
...
(0,sre.MathspeakRules.addCustomString_)("CSFoverscript",sre.MathspeakUtil.nestedOverscore);(0,sre.MathspeakRules.addContextFunction_)("CTXFordinalCounter",sre.NumbersUtil.ordinalCounter);(0,sre.MathspeakRules.addContextFunction_)("CTXFcontentIterator",sre.StoreUtil.contentIterator);(0,sre.MathspeakRules.addCustomQuery_)("CQFdetIsSimple",sre.MathspeakUtil.determinantIsSimple);(0,sre.MathspeakRules.addCustomString_)("CSFRemoveParens",sre.MathspeakUtil.removeParens);(0,sre.MathspeakRules.addCustomQuery_)("CQFresetNesting",
...
sre.MathspeakRules.getInstance().initializer=[sre.MathspeakRules.initCustomFunctions_,sre.MathspeakRules.initMathspeakRules_,sre.MathspeakRules.generateTensorRules_];sre.MathspeakSpanishUtil={};sre.MathspeakSpanishUtil.ordinalCounter=function(a,b){var c=0;return function(){return sre.Messages.NUMBERS.numberToOrdinal(++c,!1)+" "+b}};sre.MathspeakSpanishUtil.smallRoot=function(a){if(!a.childNodes||0===a.childNodes.length||!a.childNodes[0].childNodes)return[];var b=a.childNodes[0].childNodes[0].textContent;if(!/^\d+$/.test(b))return[];b=parseInt(b,10);return 1<b&&10>=b?[a]:[]};sre.UnitUtil={};sre.UnitUtil.unitMultipliers=function(a,b){var c=0;return function(){var b=sre.AuditoryDescription.create({text:sre.UnitUtil.rightMostUnit(a[c])&&sre.UnitUtil.leftMostUnit(a[c+1])?sre.Messages.UNIT_TIMES:""},{});c++;return[b]}};sre.UnitUtil.SCRIPT_ELEMENTS=[sre.SemanticAttr.Type.SUPERSCRIPT,sre.SemanticAttr.Type.SUBSCRIPT,sre.SemanticAttr.Type.OVERSCORE,sre.SemanticAttr.Type.UNDERSCORE];
...
sre.UnitUtil.oneLeft=function(a){for(;a;){if("number"===a.tagName&&"1"===a.textContent)return[a];if("infixop"!==a.tagName||"multiplication"!==a.getAttribute("role")&&"implicit"!==a.getAttribute("role"))break;a=sre.XpathUtil.evalXPath("children/*",a)[0]}return[]};sre.MathspeakSpanish=function(){sre.MathStore.call(this);this.locale="es"};goog.inherits(sre.MathspeakSpanish,sre.MathStore);goog.addSingletonGetter(sre.MathspeakSpanish);sre.MathspeakSpanish.mathStore=sre.MathspeakSpanish.getInstance();sre.MathspeakSpanish.defineRule_=goog.bind(sre.MathspeakSpanish.mathStore.defineRule,sre.MathspeakSpanish.mathStore);sre.MathspeakSpanish.defineRuleAlias_=goog.bind(sre.MathspeakSpanish.mathStore.defineRulesAlias,sre.MathspeakSpanish.mathStore);
...
(0,sre.MathspeakSpanish.addCustomString_)("CSFoverscript",sre.MathspeakUtil.nestedOverscore);(0,sre.MathspeakSpanish.addContextFunction_)("CTXFordinalCounter",sre.MathspeakSpanishUtil.ordinalCounter);(0,sre.MathspeakSpanish.addContextFunction_)("CTXFcontentIterator",sre.StoreUtil.contentIterator);(0,sre.MathspeakSpanish.addContextFunction_)("CTXFunitMultipliers",sre.UnitUtil.unitMultipliers);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFdetIsSimple",sre.MathspeakUtil.determinantIsSimple);(0,sre.MathspeakSpanish.addCustomString_)("CSFRemoveParens",
sre.MathspeakUtil.removeParens);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFoneLeft",sre.UnitUtil.oneLeft);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFresetNesting",sre.MathspeakUtil.resetNestingDepth)};
...
"[n] children/*[1]; [n] children/*[3]","self::punctuated",'@role="integral"');(0,sre.MathspeakSpanish.defineRule_)("punctuated","mathspeak.default","[m] children/*","self::punctuated");(0,sre.MathspeakSpanish.defineRule_)("unit-singular","mathspeak.default",'[t] text() (grammar:annotation="unit":translate)',"self::identifier",'@role="unit"');(0,sre.MathspeakSpanish.defineRule_)("unit-plural","mathspeak.default",'[t] text() (grammar:annotation="unit":translate:plural)',"self::identifier",'@role="unit"',
'not(contains(@grammar, "singularUnit"))');(0,sre.MathspeakSpanish.defineRule_)("unit-square","mathspeak.default",'[n] children/*[1]; [t] "cuadrado"',"self::superscript",'@role="unit"',"children/*[2][text()=2]",'name(children/*[1])="identifier"');(0,sre.MathspeakSpanish.defineRule_)("unit-cubic","mathspeak.default",'[n] children/*[1]; [t] "c\u00fabico"',"self::superscript",'@role="unit"',"children/*[2][text()=3]",'name(children/*[1])="identifier"');(0,sre.MathspeakSpanish.defineRule_)("reciprocal",
"mathspeak.default",'[t] "rec\u00edproco"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"','children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'count(preceding-sibling::*)=0 or preceding-sibling::*[@role!="unit"]');(0,sre.MathspeakSpanish.defineRule_)("reciprocal","mathspeak.default",'[t] "por"; [n] children/*[1]',"self::superscript",'@role="unit"','name(children/*[1])="identifier"','name(children/*[2])="prefixop"',
'children/*[2][@role="negative"]',"children/*[2]/children/*[1][text()=1]",'preceding-sibling::*[@role="unit"]');(0,sre.MathspeakSpanish.defineRule_)("unit-combine","mathspeak.default","[m] children/* (sepFunc:CTXFunitMultipliers)","self::infixop",'@role="unit"');(0,sre.MathspeakSpanish.defineRule_)("unit-combine-mult","mathspeak.default","[m] children/* (sepFunc:CTXFunitMultipliers);","self::infixop",'@role="multiplication" or @role="implicit"','children/*[@role="unit"]');(0,sre.MathspeakSpanish.defineRule_)("unit-combiner-singular",
"mathspeak.default",'[n] children/*[1]; [t] "por"; [m] children/*[position()>1] (grammar:!singularUnit, sepFunc:CTXFunitMultipliers)',"self::infixop",'@role="unit"','name(children/*[1])!="number"','contains(@grammar, "singularUnit")',"count(children/*)>1");(0,sre.MathspeakSpanish.defineRule_)("unit-combine-singular-first","mathspeak.default",'[n] children/*[1]; [n] children/*[2] (grammar:singularUnit); [t] "por"; [m] children/*[position()>2] (sepFunc:CTXFunitMultipliers)',"self::infixop",'@role="unit"',
'name(children/*[1])="number"',"children/*[1][text()=1]");(0,sre.MathspeakSpanish.defineRule_)("unit-combine-singular-first","mathspeak.default","[n] children/*[1]; [n] children/*[2] (grammar:singularUnit); ","self::infixop",'@role="unit"','name(children/*[1])="number"',"children/*[1][text()=1]","count(children/*)=2");(0,sre.MathspeakSpanish.defineRule_)("unit-divide","mathspeak.default",'[n] children/*[1]; [t] "por"; [n] children/*[2] (grammar:singularUnit)',"self::fraction",'@role="unit"')};
sre.MathspeakSpanish.generateTensorRules_=function(){sre.MathspeakUtil.generateTensorRules(sre.MathspeakSpanish.mathStore)};sre.MathspeakSpanish.getInstance().initializer=[sre.MathspeakSpanish.initCustomFunctions_,sre.MathspeakSpanish.initMathspeakSpanish_,sre.MathspeakSpanish.generateTensorRules_];sre.NemethUtil={};sre.NemethUtil.openingFraction=function(a){a=sre.MathspeakUtil.fractionNestingDepth(a);return Array(a).join(sre.Messages.MS.FRACTION_REPEAT)+sre.Messages.MS.FRACTION_START};sre.NemethUtil.closingFraction=function(a){a=sre.MathspeakUtil.fractionNestingDepth(a);return Array(a).join(sre.Messages.MS.FRACTION_REPEAT)+sre.Messages.MS.FRACTION_END};sre.NemethUtil.overFraction=function(a){a=sre.MathspeakUtil.fractionNestingDepth(a);return Array(a).join(sre.Messages.MS.FRACTION_REPEAT)+sre.Messages.MS.FRACTION_OVER};
...
sre.NemethUtil.numberIndicator=function(){return new sre.SemanticVisitor("nemeth",sre.NemethUtil.propagateNumber,{number:!0})};sre.NemethRules=function(){sre.MathStore.call(this);this.locale="nemeth";this.modality="braille"};goog.inherits(sre.NemethRules,sre.MathStore);goog.addSingletonGetter(sre.NemethRules);
...
sre.NemethRules.addCustomString_=goog.bind(sre.NemethRules.mathStore.customStrings.add,sre.NemethRules.mathStore.customStrings);sre.NemethRules.addAnnotators_=function(){sre.SemanticAnnotations.getInstance().register(sre.NemethUtil.numberIndicator())};
...
"not(ancestor::sqrt)","not(ancestor::root)","not(ancestor::fraction)");(0,sre.NemethRules.defineRule_)("number","default.default","[n] text()","self::number");(0,sre.NemethRules.defineRule_)("mixed-number","default.default",'[n] children/*[1]; [t] "\u2838\u2839"; [n] children/*[2]/children/*[1]; [t] "\u280c"; [n] children/*[2]/children/*[2]; [t] "\u2838\u283c"',"self::number",'@role="mixed"');(0,sre.NemethRules.defineRule_)("number-with-chars","default.default",'[t] "\u283c"; [m] CQFspaceoutNumber',
...
sre.ColorGenerator.prototype.colorLeaves_=function(a){var b=this,c=[];sre.ColorGenerator.visitStree_(this.getRebuilt().streeRoot,c,{});var d={};c=$jscomp.makeIterator(c);for(var e=c.next();!e.done;d={$jscomp$loop$prop$color$6:d.$jscomp$loop$prop$color$6},e=c.next()){e=e.value;d.$jscomp$loop$prop$color$6=this.contrast.generate();var f=!1;(f=Array.isArray(e)?e.map(function(c){return function(d){return b.colorLeave_(a,d,c.$jscomp$loop$prop$color$6)}}(d)).reduce(function(a,b){return a||b},!1):this.colorLeave_(a,
e,d.$jscomp$loop$prop$color$6))&&this.contrast.increment()}};sre.ColorGenerator.prototype.colorLeave_=function(a,b,c){return(a=sre.WalkerUtil.getBySemanticId(a,b))?(a.setAttribute(this.modality,c),!0):!1};
sre.ColorGenerator.visitStree_=function(a,b,c){if(a.childNodes.length){if(a.contentNodes.length&&("punctuated"===a.type&&a.contentNodes.forEach(function(a){return c[a.id]=!0}),"implicit"!==a.role&&b.push(a.contentNodes.map(function(a){return a.id}))),a.childNodes.length)if("implicit"===a.role){var d=[],e=[];a=$jscomp.makeIterator(a.childNodes);for(var f=a.next();!f.done;f=a.next()){var g=[];sre.ColorGenerator.visitStree_(f.value,g,c);2>=g.length&&d.push(g.shift());e=e.concat(g)}b.push(d);e.forEach(function(a){return b.push(a)})}else a.childNodes.forEach(function(a){return sre.ColorGenerator.visitStree_(a,
...
sre.Levels.prototype.get=function(a){var b=this.peek();return!b||0>a||a>=b.length?null:b[a]};sre.Levels.prototype.depth=function(){return this.level_.length};sre.Levels.prototype.clone=function(){var a=new sre.Levels;a.level_=this.level_.slice(0);return a};sre.Levels.prototype.toString=function(){for(var a="",b=0,c;c=this.level_[b];b++)a+="\n"+c.map(function(a){return a.toString()});return a};sre.Walker=function(){};sre.Walker.prototype.isActive=function(){};sre.Walker.prototype.activate=function(){};sre.Walker.prototype.deactivate=function(){};sre.Walker.prototype.speech=function(){};sre.Walker.prototype.getXml=function(){};sre.Walker.prototype.getRebuilt=function(){};sre.Walker.prototype.getFocus=function(a){};sre.Walker.prototype.setFocus=function(a){};sre.Walker.prototype.getDepth=function(){};sre.Walker.prototype.move=function(a){};sre.Walker.prototype.update=function(a){};
